...
const separarPalabras = (string) => {
    let palabrasSeparadas = string.split(' ');
...
const repetirString = (string, number) => {
    let juntarPalabras='';
    for (let i = 0; i<number; i++){
        juntarPalabras += string
    }
...
const esPrimo = (x) =>{
    ...
    if (Number.isInteger(calculo)){
      ...
      if (resultado>1){return false} else {return true}
}

// 10.- Crear la función ordenarArray que acepta como argumento un array de números y devuelva un array ordenado de menor a mayor

const ordenarArray = (x) =>{
    return x.sort();
}

// 11.- Crear la función obtenerPares que acepta como argumento un array de números y devuelva un array con los elementos pares

const obtenerPares = (x) =>{
...
const pintarArray = (array) =>{
    ...
    return newArray.forEach(element => {" " + element)
    };
  };
